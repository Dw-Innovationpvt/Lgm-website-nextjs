...
const productImages = {
  ...
  A0281: ["/assets/comming-soon.png"]
};

export default function SpacersAxleAdapter() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Precision-engineered components designed to fit between wheel bearings and axles, ensuring proper alignment and smooth rotation.
          </p>
