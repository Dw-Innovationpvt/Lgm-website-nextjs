...
// export default function InlineShoes() {
...
//           We’re working hard to bring you the Inline Shoes products. 
...
export default function InlineShoesPage() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Crafted for skaters who demand more, inline shoes combine sleek design with advanced technology.
          </p>
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Size selector */}
                {["A0156", "A0157", "A0158","A0155"].includes(product.code) && (
