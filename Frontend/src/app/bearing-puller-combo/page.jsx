...
const productImages = {
  A0301: ["/assets/A0301 - Bearing Puller Combo/AARMS Photography-147.jpg"],
};
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter((p) => ["A0301"].includes(p.code));
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          <h1 className="text-4xl font-bold font-['Arimo'] text-gray-900 mb-2">
            Bearing Puller Combo
          </h1>
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Remove and replace bearings with ease using this reliable puller
            combo.
          </p>
