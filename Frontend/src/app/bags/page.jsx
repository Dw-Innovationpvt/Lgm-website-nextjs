...
const productImages = {
  A0221: [
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-33.jpg", 
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-34.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-35.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-36.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-37.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-38.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-39.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-40.jpg",
    "/assets/101- Small Quad Bag-20250814T104425Z-1-001/AARMS-Photography-41.jpg",],
    
  A0222: ["/assets/2-Tenacity Skate/AARMS Photography-187.jpg", "/assets/2-Tenacity Skate/AARMS Photography-188.jpg"],
  A0223: [
    "/assets/3-Baby Skate Full Kit/1000210246.png",
    "/assets/3-Baby Skate Full Kit/1000210247.png",
    "/assets/3-Baby Skate Full Kit/_MG_2059.jpg",
    "/assets/3-Baby Skate Full Kit/_MG_2054.jpg",
    "/assets/3-Baby Skate Full Kit/1000210250 (1).png",
  ],
  A0225: [
    "/assets/4-Tenacity Skate Full Kit/1000210311 (1).png",
    "/assets/4-Tenacity Skate Full Kit/1000211823.png",
...
export default function Bags() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter((p) => ["A0221", "A0222", "A0223", "A0225"].includes(p.code));
  ...
  const nextImage = () =>
    setCurrentImageIndex((prev) =>
      selectedProduct && prev === selectedProduct.images.length - 1 ? 0 : prev + 1
    );

  const prevImage = () =>
    setCurrentImageIndex((prev) =>
      selectedProduct && prev === 0 ? selectedProduct.images.length - 1 : prev - 1
    );
  ...
  <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
    Carry your gear with ease using our durable and stylish skating bags, designed for convenience and performance.
  </p>
          <div className="flex items-center justify-between pb-6">
            <p className="text-gray-600">{products.length} products</p>
            <div className="flex items-center gap-4">
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                {/* Image */}
                <div
                  className={`relative group ${view === "grid" ? "h-70" : "w-1/3 h-56"}`}
                >
                  <div className="relative w-full h-64">
                    <Image
                      src={product.image}
                ...
                <div className={`flex flex-col ${view === "grid" ? "flex-1 p-6" : "w-2/3 p-6"}`}>
                  ...
                  <p className="text-gray-600 mb-4">{product.description || "Premium quality skating gear."}</p>
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75" onClick={closeImageModal}>
          <div className="relative max-w-4xl w-full mx-4" onClick={(e) => e.stopPropagation()}>
            <button onClick={closeImageModal} className="absolute -top-12 right-0 text-white">✖</button>
            {selectedProduct.images.length > 1 && (
              <>
                <button onClick={(e) => { e.stopPropagation(); prevImage(); }} className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 text-white">◀</button>
                <button onClick={(e) => { e.stopPropagation(); nextImage(); }} className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 text-white">▶</button>
              </>
            )}
            <div className="relative w-full h-[80vh]">
              <Image
