...
const productImages = {
  ...
  A0066: {
    Yellow: ["/assets/A0066 -Tyro Wheel Set/AARMS Photography-128.jpg"],
    Blue: ["/assets/A0066 -Tyro Wheel Set/AARMS Photography-129.jpg"],
    Orange: ["/assets/A0066 -Tyro Wheel Set/AARMS Photography-130.jpg"],
  },
  A0067:{
    Orange:["/assets/A0067 -Hyper Rollo Wheel Set/1000211310.png",],
    Green:["/assets/A0067 -Hyper Rollo Wheel Set/1000211313.png",
    "/assets/A0067 -Hyper Rollo Wheel Set/1000211352.png",],
  },
  A0068: ["/assets/comming-soon.png"],
  A0069: [
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter((p) =>
          ["A0065", "A0066", "A0067", "A0068", "A0069", "A0070"].includes(
            p.code
          )
        );
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Color selector */}
                {["A0066", "A0067"].includes(product.code) &&
