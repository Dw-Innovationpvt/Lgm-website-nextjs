...
const productImages = {
  A0125: [
    "/assets/49-3 X 90 Raptor/AARMS Photography-1.jpg",
    "/assets/49-3 X 90 Raptor/AARMS Photography-2.jpg",
    "/assets/49-3 X 90 Raptor/AARMS Photography-3.jpg",
    "/assets/49-3 X 90 Raptor/AARMS Photography-4.jpg",
  ],
  A0126: [
    "/assets/50- 3 X100 Raptor/AARMS Photography-9.jpg",
    "/assets/50- 3 X100 Raptor/AARMS Photography-10.jpg",
    "/assets/50- 3 X100 Raptor/AARMS Photography-11.jpg",
    "/assets/50- 3 X100 Raptor/AARMS Photography-12.jpg",
  ]
};
export default function RaptorFlashPackagePage() {
  const [view, setView] = useState("grid");
  const { addToCart } = useCart();
  const router = useRouter();
