...
//       images: [
//         quadInlinepraBearing1,
//         quadInlinepraBearing2,
//         quadInlinepraBearing3,
//         quadInlinepraBearing4,
//       ],
//       price: 3500,
//       countInStock: 20,
//       description:
    ...
    <div className="min-h-screen bg-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            High-performance skate bearings designed for smooth, fast, and reliable rolling.
          </p>
          <div className="flex items-center justify-between pb-6">
            <p className="text-gray-600">{products.length} products</p>
            <div className="flex items-center gap-4">
