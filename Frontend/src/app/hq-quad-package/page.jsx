...
const productImages = {
  A0025: [
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-3.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-41.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-42.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-43.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-44.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-202.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-203.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-204.jpg",
    "/assets/A0025-Viper Package (With Bag)/AARMS Photography-205.jpg",
  ],
  A0026: [
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-2.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-45.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-46.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-47.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-48.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-206.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-207.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-208.jpg",
    "/assets/A0026-Omen Package (With Bag)/AARMS Photography-209.jpg",
  ],
  A0027: [
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-37.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-38.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-39.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-213.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-214.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-215.jpg",
    "/assets/A0027-Yoru Package with Bag/AARMS Photography-216.jpg",
  ],
  A0028: [
    "/assets/A0028- HQ Shoes Aluminium Viper Package (With HQ Bag)/AARMS Photography-157.jpg",
    "/assets/A0028- HQ Shoes Aluminium Viper Package (With HQ Bag)/AARMS Photography-158.jpg",
    "/assets/A0028- HQ Shoes Aluminium Viper Package (With HQ Bag)/AARMS Photography-159.jpg",
    "/assets/A0028- HQ Shoes Aluminium Viper Package (With HQ Bag)/AARMS Photography-160.jpg",
    "/assets/A0028- HQ Shoes Aluminium Viper Package (With HQ Bag)/AARMS Photography-173.jpg",
  ],
  A0029: ["/assets/comming-soon.png"],
};
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter((p) =>
          ["A0025", "A0026", "A0027", "A0028", "A0029"].includes(p.code)
        );
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            The HQ Quad Package is built for skaters who want stability,
            comfort, and style in one complete set.
          </p>
