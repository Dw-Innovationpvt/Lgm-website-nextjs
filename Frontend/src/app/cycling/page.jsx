  ...
  if (products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center bg-white">
        ...
        <h4 className="text-2xl md:text-3xl font-bold text-orange-400 mb-2">
          Stay Tuned!!  
        </h4>
        <p className="text-gray-600 max-w-md">
          We’re working hard to bring you the Cycling products.
        <br/>Please check back soon for exciting updates!
        </p>
      </div>
    );
  }
