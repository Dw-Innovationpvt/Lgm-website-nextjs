...
const productImages = {
  A0118: ["/assets/comming-soon.png"],
  A0119: ["/assets/comming-soon.png"],
  A0120: ["/assets/comming-soon.png"],
};
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        data = data.filter((p) => ["A0118", "A0119", "A0120"].includes(p.code));
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Elevate your skating journey with the Fleet Altra Package.
          </p>
